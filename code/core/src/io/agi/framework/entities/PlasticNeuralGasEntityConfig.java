 ...
 */
public class PlasticNeuralGasEntityConfig extends EntityConfig {

    int widthCells = 5;
    int heightCells = 5;
    float stressLearningRate = 0.01f;
    float rankLearningRate = 0.1f;
    float rankScale = 10.0f;//120.5f; // this gives a drop-off of 1,0.5,0.25,0.12 approx
    int ageMax = 200;
    float ageDecay = 0.7f;
    float ageScale = 12.0f;

    // Latest config - perfect 1 cell per cluster and works on uniform random too
