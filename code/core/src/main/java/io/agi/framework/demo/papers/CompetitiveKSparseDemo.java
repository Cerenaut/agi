...
//        int terminationAge = 10;//9000;
        ...
        PersistenceUtil.CreateEntity( autoencoderName, CompetitiveKSparseAutoencoderEntity.ENTITY_TYPE, n.getName(), imageLabelName );
        ...
        DataRefUtil.SetDataReference( autoencoderName, CompetitiveKSparseAutoencoderEntity.INPUT, imageLabelName, ImageLabelEntity.OUTPUT_IMAGE );
...
//        learningRate = learningRate;// / (float)batchSize; // Note must reduce learning rate to prevent overshoot and numerical instability
        ...
        PersistenceUtil.SetConfig( autoencoderName, "correlationLearningRate", String.valueOf( correlationLearningRate ) );

        PersistenceUtil.SetConfig( autoencoderName, "batchSize", String.valueOf( batchSize ) );
        PersistenceUtil.SetConfig( autoencoderName, "bisectionInterval", String.valueOf( bisectionInterval ) );
