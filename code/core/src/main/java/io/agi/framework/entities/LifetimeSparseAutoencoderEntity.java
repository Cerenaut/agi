...
public class LifetimeSparseAutoencoderEntity extends Entity {
    ...
    public static final String INPUT_SPIKES = "input-spikes";

    public static final String OUTPUT_DECODED = "output-decoded";
    ...
    public static final String OUTPUT_RECONSTRUCTION = "output-reconstruction";
    ...
    public void getInputAttributes( Collection< String > attributes ) {
        ...
        attributes.add( INPUT_SPIKES );
    }

    public void getOutputAttributes( Collection< String > attributes, DataFlags flags ) {

        attributes.add( OUTPUT_DECODED );
...
//        config.age = autoencoderConfig.getAge(); no, let this be advanced by the entity
        ...
        Data inputSpikes = getData( INPUT_SPIKES );
        if( inputSpikes != null ) {
            Data decoded = new Data( input._dataSize );
            ksa.decode( inputSpikes, decoded );
            setData( OUTPUT_DECODED, decoded );
        }
