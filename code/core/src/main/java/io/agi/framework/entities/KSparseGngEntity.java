...
import io.agi.core.ann.unsupervised.KSparseGNG;
import io.agi.core.ann.unsupervised.KSparseGNGConfig;
 ...
 */
public class KSparseGngEntity extends Entity {

    public static final String ENTITY_TYPE = "k-sparse-gng";

    public static final String INPUT = "input";

    public static final String OUTPUT_INPUT_UNDERLAP = "output-input-underlap";
    ...
    public static final String OUTPUT_CELL_OVERLAP = "output-cell-overlap";
    ...
    public KSparseGngEntity( ObjectMap om, Node n, ModelEntity model ) {
        super( om, n, model );
    }
    ...
    public void getOutputAttributes( Collection< String > attributes, DataFlags flags ) {
        attributes.add( OUTPUT_INPUT_UNDERLAP );
        ...
        attributes.add( OUTPUT_CELL_OVERLAP );
    ...
    public Class getConfigClass() {
        return KSparseGngEntityConfig.class;
    }
    ...
    protected void doUpdateSelf() {
        ...
        KSparseGngEntityConfig config = ( KSparseGngEntityConfig ) _config;

        int inputs = input.getSize();

        // Create the config object:
        KSparseGNGConfig c = new KSparseGNGConfig();
        c.setup( _om,
                 getName(),
                 getRandom(),
                 inputs,
        ...
        KSparseGNG gng = new KSparseGNG( getName(), _om );
        gng._c = c;
        ...
        Data inputUnderlap = getDataLazyResize( OUTPUT_INPUT_UNDERLAP, input._dataSize );
        ...
        Data cellOverlap = getDataLazyResize( OUTPUT_CELL_OVERLAP, dataSizeCells );
        ...
        gng._inputUnderlap = inputUnderlap;
        gng._inputValues = input;
        ...
        gng._c.setLearn( config.learn );
        gng.update();

        //System.err.println( "Pop. " + gng.getCellCount() );
        setData( OUTPUT_INPUT_UNDERLAP, inputUnderlap );
        ...
        setData( OUTPUT_CELL_OVERLAP, cellOverlap );
