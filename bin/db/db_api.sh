...
./postgrest-0.2.10.0 --db-host ${2:-localhost}  --db-port ${4:-5432} --db-name agidb  --db-user agiu --db-pass ${3:-password} --db-pool 200 --anonymous agiu --port ${1:-8080} --v1schema public
